...
.venv\Scripts\python.exe -m ruff check src\spflow\beamforming\fixed_delay_diff_mvdr.py tests\beamforming\test_fixed_delay_diff_mvdr.py evaluations\beamforming\build_fixed_delay_diff_mvdr_review_pack.py src\spflow\beamforming\__init__.py
All checks passed

.venv\Scripts\pyright.exe -p artifacts\beamforming\fixed_delay_diff_mvdr\review_pack_pyright_check\pyrightconfig.json
0 errors, 0 warnings, 0 informations

.venv\Scripts\python.exe evaluations\beamforming\build_fixed_delay_diff_mvdr_review_pack.py
...
```text
evaluations/beamforming/external_fixed_delay_diff_mvdr_inputs.py
evaluations/beamforming/evaluate_external_fixed_delay_diff_mvdr_tap_tradeoff.py
evaluations/beamforming/evaluate_external_scene_renderer_fixed_delay_diff_mvdr.py
```
...
```powershell
.venv\Scripts\python.exe evaluations\beamforming\evaluate_external_fixed_delay_diff_mvdr_tap_tradeoff.py `
...
```powershell
.venv\Scripts\python.exe evaluations\beamforming\evaluate_external_scene_renderer_fixed_delay_diff_mvdr.py `
  --coe-pos C:\path\to\COE_POS `
  --coe-cbfshading C:\path\to\COE_CBFSHADING `
  --shading-df-hz 0.5 `
  --fractional-delay-raw C:\path\to\COE_DLYFILT_128 `
