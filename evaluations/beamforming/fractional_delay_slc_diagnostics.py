"""小数遅延固定整相後のSLCについてBL、FRAZ、BTR診断を保存する。"""
...
from evaluations.beamforming.scenarios.fractional_delay_slc_diagnostics import (  # noqa: E402
...
def main() -> None:
    ...
    if not filter_bank_path.exists():
        raise FileNotFoundError(
            "fractional delay filter bank not found. Run tools/design_fractional_delay_filter_bank.py "
